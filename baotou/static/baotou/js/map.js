...
function attribute_show(results){
        ...
        for(var i = 1;i < property.length-1;i += 2 ){
                ...
                var value_c = attributes[property[i]['item']] == "Null" ? "--"
                                : attributes[property[i]['item']];
                var value2_c = attributes[property[i+1]['item']] == "Null" ? "--"
                                : attributes[property[i+1]['item']];
