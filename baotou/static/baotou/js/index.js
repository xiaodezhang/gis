...
function terminal_table_show(){
    ...
    $.ajax({
        type: "POST",
        url: "WebService1.asmx/terminal_data",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (json) {
                alert("test ajax");
...
function standing_book_chart(db_table_name,value){
    ...
    $.ajax({
        type: "POST",
        url: "WebService1.asmx/GetSheShiNum",
        data: "{Table:'" + db_table_name + "',value:'" + value + "'}",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function (json) {
            var c = eval(json.d);
...
function standing_book_table(db_table_name){
    ...
    $.ajax({
            type: "POST",
            url: "WebService1.asmx/GetSheShiInfo",
            data: "{Table:'" + db_table_name + "'}",
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function (json) {
                var data = eval(json.d);
